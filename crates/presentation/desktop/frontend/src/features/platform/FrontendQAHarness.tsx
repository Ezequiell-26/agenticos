...
const checks: Check[] = [
  {id:'routes',area:'Navigation',title:'Route coverage',detail:'Every registered platform mode must resolve to a deliberate surface or a documented fallback.',state:'pass'},
