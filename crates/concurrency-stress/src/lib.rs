...
pub async fn run_stress_test(config: StressTestConfig) -> Result<StressTestResult, StressTestError> {
...
/// Run latency test
pub async fn run_latency_test(num_agents: usize, operations: usize) -> Result<Vec<Duration>, StressTestError> {
...
mod tests {
    ...
    async fn test_stress_test_10_agents() {
        ...
        info!("Stress test: {} events/sec, peak memory: {} bytes", 
    ...
    async fn test_stress_test_20_agents() {
        ...
        info!("Stress test 20 agents: {} events/sec, peak memory: {} bytes", 
              result.events_per_second, result.peak_memory);
    }
    ...
    async fn test_latency_test() {
        ...
        info!("Latency percentiles - p50: {:?}, p95: {:?}, p99: {:?}", p50, p95, p99);
