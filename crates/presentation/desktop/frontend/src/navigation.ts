...
export const navigationItems: NavigationItem[] = [
  // ── build · workspace and construction surfaces ────────────────────────────
  ...
  { id: 'project-control', label: 'Project Control Center', detail: 'Project identity, workspace, tasks, Git, environments and recovery in one place', icon: 'home', group: 'build' },
  ...
  { id: 'onboarding', label: 'Workspace Setup', detail: 'Guided first-run configuration and verification', icon: 'spark', group: 'build' },

  // ── operate · execution, review and operations ─────────────────────────────
  ...
  { id: 'remote-control', label: 'Remote Control', detail: 'Monitor remote workspaces, approve agent actions and resume sessions from another device', icon: 'cloud', group: 'operate' },
  ...
  { id: 'governance-control', label: 'Governance Control Center', detail: 'Permissions, approvals, security, hooks, audit and release gates in one safety plane', icon: 'shield', group: 'operate' },
  { id: 'quality-workbench', label: 'Quality Workbench', detail: 'Diagnostics, tests, coverage, quick fixes and release evidence in one quality surface', icon: 'check-circle', group: 'operate' },
  ...
  { id: 'qa', label: 'QA & Readiness', detail: 'Visual, accessibility and release readiness checks', icon: 'check-circle', group: 'operate' },
  ...
  // ── configure · intelligence, models and product policy ────────────────────
  ...
  { id: 'model-control', label: 'Provider & Model Control Center', detail: 'Providers, models, routing, fallback, capabilities and usage in one model plane', icon: 'network', group: 'configure' },
  ...
  { id: 'intelligence-control', label: 'Intelligence Control Center', detail: 'Context, knowledge, memory, research, prompts, evaluation and token optimization', icon: 'spark', group: 'configure' },
  { id: 'memory', label: 'Memory', detail: 'Persistent memory and cross-session recall', icon: 'database', group: 'configure' },
  { id: 'knowledge', label: 'Knowledge Studio', detail: 'Sources, retrieval, memory provenance and grounded context', icon: 'database', group: 'configure' },
  ...
  { id: 'navigation-center', label: 'Workspace Navigator', detail: 'Organize, search, favorite and reopen the complete AgentiCOS feature catalog', icon: 'command', group: 'configure' },
  { id: 'frontend-coverage', label: 'Frontend Coverage Studio', detail: 'Inventory every UI surface, ownership path, platform mode and verification contract', icon: 'check-circle', group: 'configure' },
  ...
  // ── integrate · external systems and boundaries ────────────────────────────
  { id: 'integration-control', label: 'Integration Control Center', detail: 'MCP, browser, channels, sources, credentials, webhooks and environments', icon: 'network', group: 'integrate' },
...
/* Calm rail for the Simple experience: the surfaces every user needs daily. */
export const simpleRailIds: ReadonlySet<RailMode> = new Set<RailMode>([
  'chat', 'overview', 'tasks', 'files', 'settings',
])

export type PlatformMode = Extract<RailMode, 'overview' | 'agent-control' | 'prompts' | 'permissions' | 'projects' | 'tasks' | 'codebase' | 'context' | 'rules' | 'canvas' | 'commands' | 'background' | 'subagents' | 'cloud' | 'remote-control' | 'computer' | 'operations' | 'kanban' | 'reviews' | 'checkpoints' | 'bots' | 'automations' | 'channels' | 'browser' | 'voice' | 'research' | 'evaluations' | 'notifications' | 'sessions' | 'logs' | 'analytics' | 'batch' | 'learning' | 'mcp' | 'knowledge' | 'developer-workspace' | 'git-control' | 'agent-mission' | 'task-execution' | 'session-replay' | 'evidence-inspector' | 'environment-lab' | 'agent-arena' | 'frontend-state-matrix' | 'visual-accessibility-lab' | 'collaboration-review' | 'design-system' | 'frontend-coverage' | 'navigation-center' | 'quality-workbench' | 'model-control' | 'integration-control' | 'governance-control' | 'intelligence-control' | 'project-control' | 'plugins' | 'hooks' | 'execution' | 'marketplace' | 'environments' | 'webhooks' | 'imports' | 'credentials' | 'toolsets' | 'media' | 'wake' | 'integrations' | 'security' | 'homeassistant' | 'social' | 'providers' | 'skills' | 'playground' | 'routing' | 'token-observatory' | 'versions' | 'audit' | 'onboarding' | 'qa' | 'memory' | 'tools' | 'workflows' | 'teams' | 'advanced-context' | 'usage' | 'release' | 'customization' | 'help' | 'recovery' | 'observability' | 'approvals'>
...
export const platformModes: ReadonlySet<RailMode> = new Set<PlatformMode>([
  ...
  'bots', 'automations', 'channels', 'browser', 'remote-control', 'voice', 'research', 'evaluations', 'notifications', 'sessions', 'logs', 'analytics', 'batch', 'learning', 'mcp', 'knowledge', 'developer-workspace', 'git-control', 'agent-mission', 'task-execution', 'session-replay', 'evidence-inspector', 'environment-lab', 'agent-arena', 'frontend-state-matrix', 'visual-accessibility-lab', 'collaboration-review', 'design-system', 'frontend-coverage', 'navigation-center', 'quality-workbench', 'model-control', 'integration-control', 'governance-control', 'intelligence-control', 'project-control', 'plugins', 'hooks', 'execution', 'marketplace', 'environments', 'webhooks', 'imports', 'credentials', 'toolsets', 'media', 'wake', 'integrations', 'security', 'homeassistant', 'social', 'providers', 'skills', 'playground', 'routing', 'token-observatory', 'versions', 'audit', 'onboarding', 'qa', 'memory', 'tools', 'workflows', 'teams', 'advanced-context', 'usage', 'observability', 'release', 'customization', 'help', 'recovery', 'approvals',
])
