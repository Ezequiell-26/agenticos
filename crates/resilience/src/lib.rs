...
//! Resilience toolkit based on MIT-licensed recloser patterns.
//! Source: https://github.com/lerouxrgd/recloser
            ...
            match f() {
                ...
                Err(_) if attempt < self.config.max_attempts => {
                    ...
                    backoff = Duration::from_millis(
                        millis.min(self.config.max_backoff.as_millis() as u64),
                    );
                }
...
mod tests {
    ...
    async fn test_circuit_breaker() {
        ...
        let result = breaker
            .call(|| Err::<(), _>(std::io::Error::other("test")))
            .await;
